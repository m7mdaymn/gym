...
$exerciseEmojis = [
    'Bench Press' => '🏋️', 'Incline Bench Press' => '🏋️', 'Dumbbell Flyes' => '🏋️', 'Push-Up' => '🏋️',
    'Chest Dips' => '🏋️', 'Incline Dumbbell Press' => '🏋️', 'Cable Crossovers' => '🏋️',
    'Deadlift' => '🏋️‍♂️', 'Pull-Up' => '🏋️‍♂️', 'Lat Pulldown' => '🏋️‍♂️', 'Bent-Over Row' => '🏋️‍♂️',
    'Seated Cable Row' => '🏋️‍♂️', 'T-Bar Row' => '🏋️‍♂️', 'Single-Arm Dumbbell Row' => '🏋️‍♂️',
    'Overhead Press' => '💪', 'Lateral Raise' => '💪', 'Front Raise' => '💪', 'Shrugs' => '💪',
    'Reverse Flyes' => '💪', 'Arnold Press' => '💪', 'Face Pulls' => '💪',
    'Bicep Curl' => '🏋️‍♀️', 'Tricep Dip' => '🏋️‍♀️', 'Hammer Curl' => '🏋️‍♀️', 'Skull Crushers' => '🏋️‍♀️',
    'Concentration Curl' => '🏋️‍♀️', 'Tricep Pushdown' => '🏋️‍♀️', 'Preacher Curl' => '🏋️‍♀️',
    'Squat' => '🦵', 'Lunges' => '🦵', 'Leg Press' => '🦵', 'Calf Raise' => '🦵',
    'Romanian Deadlift' => '🦵', 'Bulgarian Split Squat' => '🦵', 'Step-Up' => '🦵',
    'Plank' => '🧘', 'Russian Twist' => '🧘', 'Leg Raise' => '🧘', 'Bicycle Crunch' => '🧘',
    'Mountain Climbers' => '🧘', 'Hanging Leg Raise' => '🧘', 'Side Plank' => '🧘'
];
    ...
    try {
        if ($_POST['action'] === 'log_workout') {
            ...
            if (!empty($exercise) && $weight > 0 && $reps > 0 && $sets > 0) {
                ...
                // Store the logged workout for sharing
                $_SESSION['last_workout'] = [
                    'exercise' => $exercise,
                    'weight' => $weight,
                    'reps' => $reps,
                    'sets' => $sets,
...
<div class="main-container">
    ...
    <div class="workout-form-container">
        ...
        <?php if (isset($success)): ?>
            ...
            <?php if (isset($_SESSION['last_workout'])): ?>
                <button type="button" class="btn btn-success share-workout-btn mb-2">Share Workout</button>
            <?php endif; ?>
        <?php endif; ?>
        <?php if (isset($error)): ?>
        ...
        <?php if (!empty($templates)): ?>
            <div class="form-group mt-3">
                ...
                <select id="loadTemplate" class="form-control">
                    ...
                    <?php foreach ($templates as $name => $templateGroup): ?>
                        ...
                        <?php break; // Only show the template name once ?>
                        <?php endforeach; ?>
                    <?php endforeach; ?>
                </select>
            </div>
                        ...
                        <?php foreach ($workouts as $workout): ?>
                            <tr>
                                <td>
                                    <?php 
                                    $exercise = $workout['exercise'];
                                    echo isset($exerciseEmojis[$exercise]) ? $exerciseEmojis[$exercise] : '🤸';
                                    ?>
                                </td>
...
document.querySelectorAll('.share-workout-btn').forEach(btn => {
    btn.addEventListener('click', function() {
        const workout = <?php echo json_encode($_SESSION['last_workout'] ?? []); ?>;
        if (Object.keys(workout).length === 0) return;

        const shareText = `Workout Log\n\n` +
                          `Exercise: ${workout.exercise}\n` +
